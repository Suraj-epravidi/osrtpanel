...
<div class="col-lg-12">
    ...
    if ($page_no > 1 ) {
        echo '<a href="./products.php?page_no=' . ($page_no - 1) . '" class="icon"><span class="bold-left"></span></a>';
    }
    ...
    if ($page_no < $last_page) {
        ...
        echo '<a href="./products.php?page_no=' . ($page_no + 1) . '" class="icon"><span class="bold-right"></span></a>';
    }
